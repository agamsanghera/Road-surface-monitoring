...
public class FragmentPage3 extends Fragment {
    ...
    // Executed when the UI is viewed/opened
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        buttonReduce = (Button) v.findViewById(R.id.buttonReduceSize);
        textViewUploadedFile = (TextView) v.findViewById(R.id.textViewUploadedFile);
        ...
        switchIsConnectedWifi = (Switch) v.findViewById(R.id.switchIsConnectedWifi);
        ...
        buttonUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (activeNetwork == null) {
                    Toast.makeText(requireActivity(), R.string.toast_no_connection, Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if (switchIsConnectedWifi.isChecked()) {
                    if (activeNetwork.getType() == ConnectivityManager.TYPE_WIFI) { // Check wifi connection
                        ...
                        Toast.makeText(requireActivity(), R.string.toast_no_wifi_connection, Toast.LENGTH_SHORT).show();
                    }
        ...
        buttonDisplay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AlertDialog.Builder ad1 = new AlertDialog.Builder(requireContext());
        ...
        buttonReduce.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View V) {
                ...
                if (files1Length > 0) {
                    ...
                    Toast.makeText(requireActivity(), R.string.toast_no_file, Toast.LENGTH_SHORT).show();
                }
            }
        });
        return v;
...
//                graZ.add(Float.parseFloat(line[14]));
            ...
            e.printStackTrace();
            Toast.makeText(requireActivity(), "File hilang!", Toast.LENGTH_SHORT).show();
        }
        ...
        Toast.makeText(requireActivity(), "DEBUG: Reduce File done.", Toast.LENGTH_SHORT).show();
    }
    ...
    public void upload() {
        ...
        if (csvNum <= 0 && imageNum <= 0) {
            Toast.makeText(requireActivity(), R.string.toast_no_file, Toast.LENGTH_LONG).show();
            showFile();
            return;
        }
                ...
                handler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (file_upload_fail_count.get() > 0){
                            ...
                            Toast.makeText(requireActivity(), R.string.txt_upload_finished, Toast.LENGTH_LONG).show();
                        }
    ...
    public void showFile(){
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<>(requireActivity(), R.layout.my_custom_layout, file_list);
